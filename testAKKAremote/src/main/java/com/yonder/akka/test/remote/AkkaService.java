...
public class AkkaService {
	...
	public void init() {
		...
		System.out.println("Start ActorSystem...OK");
	...
	private Config createConfig() {
		...
		System.out.println("akka.remote.netty.tcp.hostname="+map.get("akka.remote.netty.tcp.hostname"));
		System.out.println("akka.remote.netty.tcp.port="+map.get("akka.remote.netty.tcp.port"));
	...
	public void dispose() {
		...
		System.out.println("Shutdown ActorSystem...OK");
	}
